...
export const blogPostsData = [
  {
    id: 4,
    title: "The \"No-Nonsense\" Guide to Adding Stripe Subscriptions",
    excerpt: "A practical, step-by-step walkthrough for integrating Stripe subscriptions into a Next.js app using Supabase for database/auth and handling deployment quirks on Vercel.",
    content: "In this blog post, I break down how to successfully integrate Stripe subscriptions into a SaaS stack using Next.js (App Router), Supabase for authentication and database, and Vercel for hosting. You’ll learn how to set up your database tables, configure Stripe checkout with metadata, handle webhook events securely, and avoid common deployment issues like 401 errors with Vercel’s preview protections. By the end, you should have a clear roadmap to go from local test mode to live production billing.",
    mediumUrl: "https://medium.com/@apatel13066/the-no-nonsense-guide-to-adding-stripe-subscriptions-0dfacbd2df75",
    publishedDate: "2026-01-02",
    readTime: "3 min read",
    category: "Web Development",
    tags: ["Stripe", "Next.js", "Supabase", "Vercel", "SaaS", "Subscriptions", "Webhooks", "Developer Guide"],
    image: "https://miro.medium.com/v2/resize:fit:4800/format:webp/1*Vwhk2p57JOfmr_yXtzoMgQ.png",
    featured: false
  },
  {
    id: 3,
