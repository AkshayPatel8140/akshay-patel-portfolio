  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" href="/akshay-patel-portfolio/favicon.ico" />
        <link rel="apple-touch-icon" sizes="180x180" href="/akshay-patel-portfolio/apple-touch-icon.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="/akshay-patel-portfolio/favicon-32x32.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/akshay-patel-portfolio/favicon-16x16.png" />
        <link rel="manifest" href="/akshay-patel-portfolio/site.webmanifest" />
      </head>
      <body
